...
//    }
  ...
  if (_attributes.mapLight || _attributes.mapLightPreview) {
    ...
    material3d.uniforms.lightMapIntensity = material3d.enhancedLightMap.intensity
    material3d.uniforms.lightMapFalloff = material3d.enhancedLightMap.falloff
    material3d.uniforms.lightMapCenter = material3d.enhancedLightMap.center
  }
