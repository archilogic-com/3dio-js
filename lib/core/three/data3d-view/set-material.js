...
//    }
  ...
  //material3d.side = THREE.BackSide
  ...
  if (_attributes.mapLight || _attributes.mapLightPreview) {
    ...
    material3d.enhancedLightMap.intensity = (_attributes.mapLightIntensity !== undefined) ? _attributes.mapLightIntensity : 1.0
    ...
    material3d.uniforms.lightMapIntensity.value = material3d.enhancedLightMap.intensity
    material3d.uniforms.lightMapFalloff.value = material3d.enhancedLightMap.falloff
    material3d.uniforms.lightMapCenter.value = material3d.enhancedLightMap.center
  }
