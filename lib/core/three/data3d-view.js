...
import fragmentShader from './data3d-view/fragment.glsl'
import vertexShader from './data3d-view/vertex.glsl'
    ...
    if (meshes) {
      ...
      for (i = 0, l = meshKeys.length; i < l; i++) {
        ...
        if (!self._materials3d[ meshId ]) {
          ...
          material3d.lightMapIntensity = -1.0*/
