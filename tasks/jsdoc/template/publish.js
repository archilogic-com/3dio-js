 ...
 */
function buildNav(members, packageInfo) {
  var nav = []
  var seen = {}
  var seenTutorials = {}
  ...
  nav = nav.concat(buildMemberNav(members.classes, "", seen, linkto))
  ...
  nav = nav.concat(buildMemberNav(members.namespaces, "", seen, linkto))
...
exports.publish = function(taffyData, opts, tutorials) {
  ...
  // once for all
  view.nav = buildNav(members, packageInfo)
