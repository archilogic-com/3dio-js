...
<head>
  ...
  <script src="https://3d.io/releases/3dio-js/1.0.0-beta.2/3dio.min.js"></script>
</head>
<body>
<a-scene>
...
* browser: `<script src="https://3d.io/releases/3dio-js/1.0.0-beta.2/3dio.min.js"></script>`
