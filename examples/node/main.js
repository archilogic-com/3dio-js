...
var key = '/fd72bf39-9d3a-471f-a4ff-ecaa3f5ff30b/bake/2017-04-15_22-45-14_XsiltX/regular/lighting.gz.data3d.buffer'
...
// BASE.product.get('d23062b7-6ec4-45c0-9cee-c96d835b5f54').then(console.log)


// BASE.store.put( Buffer.from('Hello World!', 'utf-8') ).then(function(key){
//   console.log(key)
// }).catch(console.error)